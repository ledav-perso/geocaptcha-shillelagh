...
GeocaptchaAdapter
---------------
read-only Shillelagh adapter that uses Geocaptcha API admin:

  - geocaptcha://session     -> get sessions collection
  - geocaptcha://cuser       -> get cusers collection
  - geocaptcha://kingpin     -> get kingpins collection

Assumptions:
  * Apache superset configuration adds :
